...
class WifiManager:
    ...
    def __init__(self, ssid = None, password = None, reboot = True, debug = False):
        ...
        if len(ssid) > 32:
            ...
            self.ap_ssid = ssid
        if len(password) < 8:
            raise Exception('The password cannot be less than 8 characters long.'+len(password))
        else:
    ...
    def web_server(self):
        ...
        while True:
            if self.wlan_sta.isconnected():
                ...
                match = re.search('ssid=([^&]*)&password=([^&]*)&name_device=([^&]*)&password_device=([^&]*)&topic_pub=([^&]*)&broker=([^&]*)&default=(.*)', self.url_decode(self.request))
                if match:
                    topic = match.group(3).decode('utf-8')
                    broker = match.group(6).decode('utf-8')
                    password_device = match.group(4).decode('utf-8')
                    publish = match.group(5).decode('utf-8')
                    #if topic == '':
                    #  default = match.group(4).decode('utf-8')
                    #  topic = default
    ...
    def handle_root(self):
        ...
        self.client.sendall("""
            ...
            <html lang="en">
                ...
                <body>
                    <div style="background-color: rgb(45, 45, 139);">
                        <h1 style="color: white; font-size: 30px; padding: 10px; padding-left: 15px;">ELMA WIFI Configuration</h1>
                    </div>
        ...
        self.client.sendall("""
                        ...
                        <p><label for="name_device">Name this device&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;</label><input type="text" id="name_device" name="name_device" placeholder="Required" required></p>
                        <p><label for="password_device">Password device &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </label><input type="password" id="password_device" name="password_device" required></p>
                        <p><label for="topic_pub">Publish to&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;</label><input type="text" id="topic_pub" name="topic_pub" placeholder="topic" required></p>
                        <p><label for="broker">Broker&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;</label><input type="text" id="broker" name="broker" placeholder="broker" required></p>
                        <input type="text" id="default" name="default" value="active1" hidden>
                        <p><input style="background-color:rgb(45, 45, 139); color: white; padding: 5px; padding-left:10px; padding-right:10px; border-radius: 12px;" type="submit" value="Connect"></p>
                    </form>
                </body>
            </html>
        """)
        ...
        if match:
            ...
            if len(ssid) == 0:
                self.send_response("""
                    ...
                    <p style="font-size: 30px; font-family: monospace;">SSID must be providaded!</p>
                    <p style="position: relative; margin-top:-20px;">Go back and try again!</p>
                """, 400)
                ...
                self.send_response("""
                    ...
                    <p style="font-size: 20px;">Successfully connected to  </p>
                    <h1>{0}</h1>
                    <p style="font-size: 13px;">IP address: <b>{1}</b></p>
                ...
                self.send_response("""
                    ...
                    <p style="font-size: 20px;">Could not connect to</p>
                    <h1>{0}</h1>
                    <p style="font-size: 13px;">Go back and try again!</p>
                """.format(ssid))
                time.sleep(5)
                machine.reset()
        else:
            self.send_response("""
                ...
                <p style="font-size: 20px;">Parameters not found!</p>
            """, 400)
            time.sleep(5)
    ...
    def handle_not_found(self):
        self.send_response("""
            <p>Page not found!</p>
            <p>{0}<p>
        """.format(self.url_decode(self.request)), 404)
